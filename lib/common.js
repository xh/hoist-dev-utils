...
// Higher floor for `configureRsbuild()`. SWC emits TypeScript-style legacy decorators, under which
// field decorators receive no descriptor - hoist-react's `@persist` depended on Babel's
// `descriptor.initializer` until v88, and any earlier release fails at startup with a TypeError.
